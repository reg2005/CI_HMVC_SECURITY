...
$lang['forgot_password_unsuccessful_is_not_active'] 	= 'Невозможен сброс пароля т.к. аккаунт не активирован';
...
$lang['email_activate_heading']    = 'Активировать акаунт %s';
$lang['email_activate_subheading'] = 'Ваш email был указан при регистрации на mir-ndv, для продолжения регистрации пройдите по ссылке:';
