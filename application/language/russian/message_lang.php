...
$lang['create_user_referal_label']                     = 'Реферал:';
...
$lang['forgot_password_subheading']              = 'Пожалуйста введите ваш email и мы сможем отправить вам письмо с новым паролем.';
...
$lang['reset_password_new_password_label']                    = 'Новый пароль (минимум 4 символа):';
...
$lang['email_forgot_password_heading']    = 'Здравствуйте! %s';
$lang['email_forgot_password_subheading'] = 'Вы запросили сброс пароля. Для завершения смены пароля перейдите по %s.';
