...
$config['smarty.cache_lifetime'] = 60;

// Where templates are compiled
$config['smarty.compile_directory'] = APPPATH.'cache/compiled/';

// Where templates are cached
$config['smarty.cache_directory'] = APPPATH.'cache/cached/';
...
$config['smarty.template_error_reporting'] = E_ALL;
